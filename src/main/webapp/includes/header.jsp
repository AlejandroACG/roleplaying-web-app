...
<html lang="en">
  <head>
      ...
      <title>The Tavern Roleplaying Club</title>
      <link rel="stylesheet" href="style/style.css">
      <link rel="shortcut icon" href="../roleplaying-web-app_data/favicon.png"></head>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol id="dice-1" viewBox="0 0 16 16">
        ...
        <symbol id="dice-6" viewBox="0 0 16 16">
      ...
      <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
          ...
          <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="#" class="nav-link px-2">Players</a></li>
